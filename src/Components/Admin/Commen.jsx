...
import { getUsers } from '../../Axios/Services/AdminServices'
...
function Commen() {
      ...
      <ul className="space-y-2 tracking-wide mt-8 ">
        ...
        <li>
          <button onClick={()=>{
            ...
            SetRefresh(!refresh)
          }} className="px-4 py-3 w-full flex items-center space-x-4 rounded-md text-gray-600 group hover:bg-blue-500">
  ...
  <div className="ml-auto mb-6 lg:w-[75%] xl:w-[80%] 2xl:w-[85%]">
   ...
   {localStorage.getItem('component')==='dashboard'? <Dashboard/>:''}
   {localStorage.getItem('component')==='users'? <UsersList users={users} refresh={refresh} SetRefresh={SetRefresh} />:''}
  </div>
</div>
    </>
  )
