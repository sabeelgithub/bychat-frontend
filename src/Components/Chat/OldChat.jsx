...
function OldChat() {
  ...
  return (
    <>
    {loader ? <Loaders/> : <div className="flex h-full antialiased text-gray-800">
    <div className="md:flex flex-row h-full w-full overflow-x-hidden">
      <div className="flex flex-col  pl-6 pr-2 md:w-64  bg-orange-300 md:ml-4  md:mr-1 mt-1 flex-shrink-0 rounded-xl">
        <div className="flex flex-col">
          
          <div className="flex flex-col space-y-1 -mx-2 h-96  overflow-y-scroll  no-scrollbar ">
      ...
      <div className="flex flex-col flex-auto h-96 p-1 md:mr-3">
